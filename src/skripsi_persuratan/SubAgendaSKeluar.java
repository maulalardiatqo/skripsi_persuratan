 ...
 * @author galaxy.co
 */
public class SubAgendaSKeluar extends javax.swing.JFrame {

    /**
     * Creates new form SubAgendaSKeluar
     */
    public SubAgendaSKeluar() {
        initComponents();
    }

    SubAgendaSKeluar(String no_surat) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("TAMPILAN SURAT KELUAR");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SubAgendaSKeluar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SubAgendaSKeluar().setVisible(true);
            }
        });
    }
